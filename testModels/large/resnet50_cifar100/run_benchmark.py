"""Benchmark Ghost+FAISS vs Original TracIn (ResNet-50, CIFAR-100, ~23.7M params)."""
...
from testModels.large.resnet50_cifar100.data import Cifar100Dataset
from testModels.large.resnet50_cifar100.model import build_resnet50_cifar100
...
def main() -> None:
    ...
    p.add_argument("--output-dir", default="outputs/benchmarks/resnet50_cifar100")
    ...
    def model_factory() -> nn.Module:
        torch.manual_seed(args.seed)
        return build_resnet50_cifar100(num_classes=100)
    ...
    # ResNet50: nearly all params in Conv2d.  With conv ghost support, hook
    # both conv and FC layers for realistic coverage.
    ...
    plot_model_benchmark(
        "resnet50_cifar100", ghost_cmp, original_scores, out, sample_ids=compare_ids,
    )
