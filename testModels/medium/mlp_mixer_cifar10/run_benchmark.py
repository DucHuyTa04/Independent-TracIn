"""Benchmark Ghost+FAISS vs Original TracIn (MLP-Mixer, CIFAR-10)."""
...
from testModels.medium.mlp_mixer_cifar10.model import MixerMicro
...
def main() -> None:
    ...
    p.add_argument("--output-dir", default="outputs/benchmarks/mlp_mixer_cifar10")
    ...
    plot_paths = plot_model_benchmark(
        "mlp_mixer_cifar10", ghost_cmp, original_scores, out, sample_ids=compare_ids,
    )
